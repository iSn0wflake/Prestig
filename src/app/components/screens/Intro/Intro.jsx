                    ...
                    <div className='intro__content__catalog'>
                        <form className="filter">
                            <div className='filter__button' >
                                <button className='filter__button__btn'><i class="fa-solid fa-sliders"></i> Filterlash</button>
                            </div>
                            <div className="filter__el">
                                ...
                                <details open className="filter__group">
                                    ...
                                    <a href="#" className="filter__more">Barchasini ko'rish</a>
                                    </div>
                                </details>
                        ...
                        <div className='intro__content__catalog__cards'>
                            <div className='intro__content__catalog__card'>
                                <div className='intro__content__catalog__card__image'>
                                    <img className='intro__content__catalog__card__image__img' src={image} alt="image" />
                                </div>
                                <div className='intro__content__catalog__card__info'>
                                    <h3 className='intro__content__catalog__card__info__title'>Malibu rul SUPER 3000 X1 5W-40 GM Uzbekistan</h3>
                                    <div className='intro__content__catalog__card__info__bottom'>
                                        <p className='intro__content__catalog__card__info__price'>235$ <del className='old'>250$</del></p>
